...
setproctitle setuptools six spidev systemd tabulate urllib3 wrapt xlib yaml yarl pyotp qrcode serial serial-asyncio evdev build usb cbor2 ftdi smbus2 luma.core luma.oled" )
  do
